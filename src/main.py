...
if __name__ == '__main__':
    ...
    nasa_data = pd.read_csv('../data/nasa/nasa_global_landslide_catalog_point.csv')
    data_processing.get_final_result(original_data, loc_results, time_results, nasa_data)
